        ...
        if (id && hotelData[id as keyof typeof hotelData]) {
          ...
          if (res.ok) {
            ...
            found = {
              ...
              rating: Math.floor(Number(data.rating)) || 5,
              img: data.images?.[0] || data.image || 'https://images.unsplash.com/photo-1566073771259-6a8506099945?q=80&w=2940&auto=format&fit=crop',
              images: data.images || (data.image ? [data.image] : []),
              type: data.type || (data.amenities && data.amenities.length > 0 ? data.amenities[0] : 'Hotel'),
