    ...
    <section ref={containerRef} className="py-32 md:py-48 px-6 md:px-12 w-full relative overflow-hidden bg-transparent text-forest dark:text-[#fdfbf7]">
      ...
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10 transform-style-3d">
        ...
        <div ref={imageRef} className="relative h-[600px] md:h-[900px] w-full hidden md:block perspective-[1200px]">
          <div className="beauty-img-1 absolute top-0 right-[5%] w-[65%] h-[75%] z-10 overflow-hidden rounded-2xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)] transform-style-3d" style={{ transform: 'translateZ(40px)' }}>
            <img 
              src="https://images.unsplash.com/photo-1553979459-d2229ba7433b?q=80&w=2868&auto=format&fit=crop" 
              alt="Tea Plantations" 
              className="w-[120%] h-[120%] -top-[10%] -left-[10%] absolute object-cover"
            />
          </div>
          <div className="beauty-img-2 absolute bottom-[5%] left-[0%] w-[55%] h-[65%] z-20 overflow-hidden rounded-2xl shadow-[0_40px_80px_-20px_rgba(0,0,0,0.2)] border border-white/40 backdrop-blur-md transform-style-3d" style={{ transform: 'translateZ(80px)' }}>
            <img 
        ...
        <div className="h-[500px] w-full md:hidden mt-12 overflow-hidden rounded-2xl relative shadow-2xl">
           <img 
              src="https://images.unsplash.com/photo-1553979459-d2229ba7433b?q=80&w=2868&auto=format&fit=crop" 
              alt="Tea Plantations" 
