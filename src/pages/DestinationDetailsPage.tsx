...
const DestinationDetailsPage = () => {
  ...
  const destination = destinationsData[destKey as keyof typeof destinationsData];
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-12 py-24 relative z-30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="dest-details-reveal">
               <Link to="/plan-trip" className="w-full flex items-center justify-center gap-2 bg-orange text-[#fdfbf7] px-8 py-5 rounded-xl hover:bg-forest hover:text-[#fdfbf7] dark:hover:bg-[#fdfbf7] dark:hover:text-[#0a0f0d] transition-all shadow-lg hover:shadow-orange/30 group">
